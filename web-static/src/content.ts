// ============================================================
//  WEDDING INVITATION — CENTRAL CONTENT CONFIGURATION
//  Edit everything here. All components read from this object.
// ============================================================
...
export interface WeddingContent {
  ...
  dates: {
    /** ISO datetime — drives the countdown timer */
    weddingDatetime: string;
    /** Human-readable date shown in the hero section */
    weddingDateDisplay: string;
    /** Shown on the InviteCard "Save the Date" block */
    saveTheDateDisplay: string;
    /** Shown in the MagicalDateReveal overlay */
